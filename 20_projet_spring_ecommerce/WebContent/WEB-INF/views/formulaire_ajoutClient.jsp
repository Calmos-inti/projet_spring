	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-sm-10 ">
				...
				<form:form modelAttribute="clientCommand" action="${pageContext.request.contextPath}/accueil/ajouterClient" method="post">
					...
					<div class="row justify-content-center">
						<div class="col-4">
							<div class="form-group row justify-content-md-center">
								<form:button class="btn btn-outline-primary btn-lg btn-block" type="submit">Créer le compte</form:button>
							</div>
						</div>
					</div>
				</form:form>
