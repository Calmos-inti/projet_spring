...
<div>
		<h1 style="background-color: lightorange; color: darkblue">Modification d'un produit</h1>
		<form:form modelAttribute="produitUpCommand" action="${pageContext.request.contextPath}/produit/update" method="post">
	...
	<form:hidden path="idProduit"/>
   		...
   		<td> <form:label path="description"> Description :</form:label> </td>
				...
				<tr>
					<td colspan="3">
						<input type="submit" value="Modifier ce nouveau produit"/>
					</td>
				</tr>
