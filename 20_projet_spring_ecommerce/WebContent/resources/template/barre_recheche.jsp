		...
		<ul class="navbar-nav mr-auto">
			...
			<s:authorize access="hasRole('ROLE_PRODUIT')">
				<li class="nav-item active"><a class="nav-link"
					href="${pageContext.request.contextPath}/produit/afficherCommandes">Gestion
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="dropdown07">
						<a class="dropdown-item"
							href="${pageContext.request.contextPath}/user/liste/">Afficher
							Tous</a> <a class="dropdown-item"
							href="${pageContext.request.contextPath}/addUser">Ajouter</a>
					</div></li>
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="dropdown07">
					<a class="dropdown-item"
						href="${pageContext.request.contextPath}/caroussel/liste/">Afficher
						Tous</a> <a class="dropdown-item"
						href="${pageContext.request.contextPath}/addCaroussel">Ajouter</a>
				</div></li>
					</s:authorize>
		</ul>
